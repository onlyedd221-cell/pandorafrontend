...
`,
  ...
  },
  {
    id: 23099302305,
    name: "Hellena Milton",
    image: "/images/mistress3.jpg",
    bio: "Young Domme with fresh energy and creativity.",
    description: `
At just 22, Hellena Milton combines youthful energy with an intuitive understanding of control and play. 
...
`,
    ...
    contactInfo: {
      email: "hellena.milton22@gmail.com",
      phone: "Available upon request",
    },
  },
...
export default function WelcomePage() {
  ...
  // ⏳ Manage which group of bookings is shown
  const [bookingGroup, setBookingGroup] = useState(0);
  ...
  // ⏳ Change booking group every 1 hour
 // ⏳ Change booking group every 1 day
useEffect(() => {
  const timer = setInterval(() => {
    setBookingGroup((prev) => (prev + 1) % Math.ceil(bookingsData.length / 4));
  }, 86400000); // 24 hours
  ...
  const startIndex = bookingGroup * 4;
  const endIndex = startIndex + 4;
  const visibleBookings = bookingsData.slice(startIndex, endIndex);
  ...
  return (
    <div className="font-sans text-white relative">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center transition-transform duration-6000 ease-in-out transform scale-100 hover:scale-105"
          style={{
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-lg sm:text-xl mb-6 font-light tracking-wide">
            ...
            <span className="font-bold text-pink-400">Over 30 YEARS!</span>
          </p>
